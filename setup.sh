...
sudo apt install -y git curl wget build-essential zip zsh zsh-autosuggestions zsh-syntax-highlighting screen tmux
...
cp ~/.workspace-setup/templates/.tmux.conf ~/
zsh
